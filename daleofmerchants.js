...
define("components/Images", ["require", "exports", "components/DaleCard"], function (require, exports, DaleCard_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Images = (function () {
        ...
        Images.setCardStyle = function (div, card_type_id) {
            ...
            if (card_type_id !== undefined) {
                ...
                if (card_type_id = DaleCard_1.DaleCard.CT_SOUNDDETECTORS) {
...
define("components/DaleStock", ["require", "exports", "ebg/stock", "components/DaleCard", "components/Images", "components/types/DaleWrapClass", "ebg/stock"], function (require, exports, Stock, DaleCard_2, Images_3, DaleWrapClass_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var DaleStock = (function (_super) {
        ...
        function DaleStock() {
            ...
            _this.duration = 500;
            _this.orderedSelection = new DaleCard_2.OrderedSelection();
        ...
        DaleStock.prototype.getAllDaleCards = function () {
            ...
            for (var _i = 0, _a = this.items; _i < _a.length; _i++) {
                var item = _a[_i];
                cards.push(new DaleCard_2.DaleCard(item.id));
            }
            return cards;
        };
        DaleStock.prototype.getSelectedValue = function () {
            ...
            for (var _i = 0, _a = this.orderedSelection.get(); _i < _a.length; _i++) {
                var card_id = _a[_i];
                value += new DaleCard_2.DaleCard(card_id).effective_value;
            }
            return value;
        };
        ...
        DaleStock.prototype.getSelectedDaleCards = function () {
            ...
            for (var _i = 0, _a = this.orderedSelection.get(); _i < _a.length; _i++) {
                var card_id = _a[_i];
                cards.push(new DaleCard_2.DaleCard(card_id));
            }
            return cards;
        };
        ...
        DaleStock.prototype.isClickable = function (card_id) {
            ...
            switch (this.selectionMode) {
                ...
                case 'clickOnFinishAndSnack':
                    return card.trigger == 'onFinish' || card.effective_type_id == DaleCard_2.DaleCard.CT_SNACK;
                ...
                case 'clickWhitelist':
                    ...
                    return false;
                case 'clickOvertime':
                    return card.effective_type_id == DaleCard_2.DaleCard.CT_OVERTIME;
                case 'single':
                    return true;
                case 'singleAnimalfolk':
                    return card.isAnimalfolk();
        ...
        DaleStock.prototype.containsTrigger = function (trigger) {
            for (var i in this.items) {
                var item = this.items[i];
                if (new DaleCard_2.DaleCard(item.id).trigger == trigger) {
                    return true;
                }
            }
            return false;
        ...
        DaleStock.prototype.countTypeId = function (type_id) {
            ...
            for (var i in this.items) {
                var item = this.items[i];
                if (new DaleCard_2.DaleCard(item.id).effective_type_id == type_id) {
                    nbr++;
                }
            }
            return nbr;
