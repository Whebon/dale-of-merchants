...
define("components/CoinManager", ["require", "exports", "components/DaleIcons", "components/types/DaleWrapClass", "components/DaleCard"], function (require, exports, DaleIcons_5, DaleWrapClass_4, DaleCard_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var CoinManager = (function () {
        ...
        CoinManager.prototype.init = function (page) {
            ...
            for (var player_id in page.gamedatas.players) {
                ...
                var coins_icon = DaleIcons_5.DaleIcons.getCoinIcon();
        ...
        CoinManager.prototype.setSelectionMode = function (mode, wrapClass, actionLabelText) {
            ...
            switch (this.selectionMode) {
                case 'explicit':
                    (_b = this.wrap) === null || _b === void 0 ? void 0 : _b.classList.add("daleofmerchants-clickable");
                    break;
                case 'none':
                    (_c = this.wrap) === null || _c === void 0 ? void 0 : _c.classList.remove("daleofmerchants-clickable");
                    break;
            }
        };
    ...
    var DaleOfMerchants = (function (_super) {
        ...
        DaleOfMerchants.prototype.setup = function (gamedatas) {
            ...
            for (var player_id in gamedatas.players) {
                ...
                var handsize_icon = DaleIcons_6.DaleIcons.getHandIcon();
        ...
        DaleOfMerchants.prototype.onEnteringState = function (stateName, args) {
            ...
            switch (stateName) {
                ...
                case 'client_essentialPurchase':
                    ...
                    for (var _i = 0, _d = client_essentialPurchase_args.funds_card_ids.slice().reverse(); _i < _d.length; _i++) {
                        var card_id = _d[_i];
                ...
                case 'client_glue':
                    ...
                    for (var _e = 0, _f = client_glue_args.funds_card_ids.slice().reverse(); _e < _f.length; _e++) {
                        var card_id = _f[_e];
                        this.myHand.selectItem(card_id, true);
                ...
                case 'specialOffer':
                    ...
                    break;
                case 'client_rottenFood':
                    for (var _g = 0, _h = Object.entries(this.allDecks); _g < _h.length; _g++) {
                        var _j = _h[_g], player_id = _j[0], deck = _j[1];
                        if (+player_id != this.player_id) {
                ...
                case 'client_siesta':
                    ...
                    break;
                case 'nightShift':
                    for (var _r = 0, _s = Object.values(this.playerDecks); _r < _s.length; _r++) {
                        var deck = _s[_r];
                        deck.setSelectionMode('noneCantViewContent');
                    }
                ...
                case 'client_ruthlessCompetition':
                    ...
                    for (var _t = 0, _u = this.gamedatas.playerorder; _t < _u.length; _t++) {
                        var player_id = _u[_t];
        ...
        DaleOfMerchants.prototype.format_string_recursive = function (log, args) {
            ...
            if (log && args && !args['processed']) {
                ...
                if ('coin_icon' in args) {
                    var iconTpl = DaleIcons_6.DaleIcons.getCoinIcon();
        ...
        DaleOfMerchants.prototype.onSpend = function () {
            ...
            if (total_value < args.cost) {
                this.showMessage(_("Insufficient funds") + " (".concat(total_value, "/").concat(args.cost, ")"), 'error');
                return;
            }
