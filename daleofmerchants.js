...
define("components/DaleCard", ["require", "exports", "components/DaleIcons", "components/Images", "components/DaleDie", "components/AbstractOrderedSelection", "components/PlayerClock"], function (require, exports, DaleIcons_5, Images_2, DaleDie_1, AbstractOrderedSelection_2, PlayerClock_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("components/Pile", ["require", "exports", "components/Images", "components/DaleCard", "components/types/DaleWrapClass"], function (require, exports, Images_4, DaleCard_2, DaleWrapClass_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Pile = void 0;
    var Pile = (function () {
        ...
        Pile.prototype.openPopin = function () {
            ...
            var _loop_4 = function (card) {
                ...
                if (this_4.isClickable(card)) {
                    div.classList.add("daleofmerchants-clickable");
                    if (this_4.isClickableHighPriority(card)) {
                        div.classList.add("daleofmerchants-high-priority");
                    }
                    else {
                        div.classList.remove("daleofmerchants-high-priority");
...
define("components/MarketBoard", ["require", "exports", "components/DaleCard", "components/Images", "components/CardSlot", "components/types/DaleWrapClass", "components/DaleIcons"], function (require, exports, DaleCard_4, Images_6, CardSlot_1, DaleWrapClass_3, DaleIcons_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("components/Stall", ["require", "exports", "components/DaleCard", "components/Images", "components/CardSlot", "components/DaleIcons"], function (require, exports, DaleCard_5, Images_7, CardSlot_2, DaleIcons_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("components/types/MainClientState", ["require", "exports", "components/DaleCard", "components/DaleIcons"], function (require, exports, DaleCard_6, DaleIcons_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("bgagame/daleofmerchants", ["require", "exports", "ebg/core/gamegui", "components/DaleStock", "components/Pile", "components/HiddenPile", "components/DaleCard", "components/MarketBoard", "components/Stall", "components/types/MainClientState", "components/Images", "components/TargetingLine", "components/types/DbEffect", "components/DaleDeckSelection", "components/DaleDie", "components/DaleIcons", "components/CoinManager", "components/PlayerClock", "components/types/TranslatableStrings", "ebg/counter", "ebg/stock"], function (require, exports, Gamegui, DaleStock_1, Pile_2, HiddenPile_1, DaleCard_9, MarketBoard_1, Stall_1, MainClientState_1, Images_8, TargetingLine_1, DbEffect_1, DaleDeckSelection_2, DaleDie_2, DaleIcons_10, CoinManager_1, PlayerClock_2, TranslatableStrings_1) {
    ...
    var DaleOfMerchants = (function (_super) {
            ...
            switch (stateName) {
                ...
                case 'DEPRECATED_blindfold':
                    ...
                    var _loop_10 = function (value) {
                        ...
                        this_9.addActionButton("button-" + value, DEPRECATED_blindfold_label, (function () { return _this.onDEPRECATED_BlindfoldGuess(value); }).bind(this_9));
                        DEPRECATED_blindfold_baseValue += 1;
                    };
                    var this_9 = this;
                    for (var _j = 0, _k = DEPRECATED_blindfold_args.possible_values; _j < _k.length; _j++) {
                        var value = _k[_j];
                        _loop_10(value);
                    }
                    break;
                case 'DEPRECATED_blindfoldDecideValue':
                    ...
                    var _loop_11 = function (value) {
                        ...
                        this_10.addActionButton("button-" + value, DEPRECATED_blindfoldDecideValue_label, (function () { return _this.onDEPRECATED_BlindfoldDecideValue(value); }).bind(this_10));
                        DEPRECATED_blindfoldDecideValue_baseValue += 1;
                    };
                    var this_10 = this;
                    for (var _l = 0, _m = DEPRECATED_blindfoldDecideValue_args.possible_values; _l < _m.length; _l++) {
                        var value = _m[_l];
                        _loop_11(value);
                    }
                ...
                case 'client_pompousProfessional':
                    ...
                    var _loop_12 = function (animalfolk_id) {
                        ...
                        this_11.addActionButton("animalfolk-button-" + animalfolk_id, animalfolk_name, function () { return _this.onPompousProfessional(animalfolk_id); });
                    };
                    var this_11 = this;
                ...
                case 'client_periscopeAnimalfolkId':
                    ...
                    var _loop_13 = function (animalfolk_id) {
                        var animalfolk_name = this_12.getAnimalfolkName(animalfolk_id);
                        this_12.addActionButton("animalfolk-button-" + animalfolk_id, animalfolk_name, function () { return _this.onPeriscopeAnimalfolkId(animalfolk_id); });
                    };
                    var this_12 = this;
                    for (var _q = 0, _r = this.gamedatas.animalfolkIds; _q < _r.length; _q++) {
                        var animalfolk_id = _r[_q];
                        _loop_13(animalfolk_id);
                    }
                    this.addActionButtonCancelClient();
                    break;
                case 'client_periscopeValue':
                    var _loop_14 = function (value) {
                        ...
                        this_13.addActionButton("animalfolk-button-" + value, value.toString(), callback.bind(this_13));
                    };
                    var this_13 = this;
                    for (var _s = 0, _t = [1, 2, 3, 4, 5]; _s < _t.length; _s++) {
                        var value = _t[_s];
                        _loop_14(value);
                    }
                    this.addActionButtonCancelClient();
                ...
                case 'anotherFineMess':
                    ...
                    if (looseMarbles_args.die_value1 == DaleDie_2.DaleDie.DIE_DECK) {
                        for (var _x = 0, _y = Object.entries(this.playerDecks); _x < _y.length; _x++) {
                            var _z = _y[_x], player_id = _z[0], deck = _z[1];
                            deck.setSelectionMode('topIncludingEmpty', undefined, 'daleofmerchants-wrap-technique');
                        }
                    }
        ...
        DaleOfMerchants.prototype.addActionButtonsOpponent = function (onOpponentHandler, include_player, suffix, player_ids) {
            ...
            var _loop_15 = function (opponent_id) {
                if (include_player || opponent_id != this_14.player_id) {
                    var name_1 = this_14.gamedatas.players[opponent_id].name;
                    var color = this_14.gamedatas.players[opponent_id].color;
                    var label = "<span style=\"font-weight:bold;color:#".concat(color, ";\">").concat(name_1).concat(suffix, "</span>");
                    this_14.addActionButton("opponent-selection-button-" + opponent_id, label, function () { onOpponentHandler(+opponent_id); }, undefined, false, 'gray');
                }
            };
            var this_14 = this;
            for (var _i = 0, player_ids_1 = player_ids; _i < player_ids_1.length; _i++) {
                var opponent_id = player_ids_1[_i];
                _loop_15(opponent_id);
            }
        };
        ...
        DaleOfMerchants.prototype.onClickTechnique = function (card) {
            ...
            switch (card.effective_type_id) {
                ...
                case DaleCard_9.DaleCard.CT_REPLACEMENT:
                    ...
                    break;
                case DaleCard_9.DaleCard.CT_DEPRECATED_FASHIONHINT:
                    fizzle = (this.marketDiscard.size + this.marketDeck.size) == 0;
                    if (fizzle) {
                        this.clientScheduleTechnique('client_fizzle', card.id);
                    }
        ...
        DaleOfMerchants.prototype.onClickPassive = function (card, postCleanUp) {
            ...
            if (type_id != DaleCard_9.DaleCard.CT_DEPRECATED_MARKETDISCOVERY) {
        ...
        DaleOfMerchants.prototype.onBadOmenUndo = function () {
            ...
            if (args.toss_card_id != -1) {
                if (new DaleCard_9.DaleCard(args.toss_card_id).isAnimalfolk()) {
                ...
                else if (new DaleCard_9.DaleCard(args.toss_card_id).isMonoCard()) {
                    ...
                    this.myLimbo.addDaleCardToStock(new DaleCard_9.DaleCard(args.toss_card_id), 'overall_player_board_' + this.player_id);
                }
            }
            this.mainClientState.leave();
        };
        ...
        DaleOfMerchants.prototype.notif_scheduleTechnique = function (notif) {
            if (notif.args.player_id == this.player_id) {
                ...
                if ($(this.myHand.control_name + '_item_' + card_id)) {
                    this.mySchedule.addDaleCardToStock(DaleCard_9.DaleCard.of(notif.args.card), this.myHand.control_name + '_item_' + card_id);
                ...
                if ($(this.myLimbo.control_name + '_item_' + card_id)) {
                    this.monoSchedule.addDaleCardToStock(DaleCard_9.DaleCard.of(notif.args.card), this.myLimbo.control_name + '_item_' + card_id);
