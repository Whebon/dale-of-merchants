...
if (!defined('CT_CARDBACK')) {
    ...
    define('CT_DODO3', 122);
    define('CT_DODO4', 123);
    define('CT_DODO5A', 124);
    define('CT_DODO5B', 125);
    define('CT_CAPUCHIN1', 126);
    define('CT_CAPUCHIN2', 127);
    define('CT_CAPUCHIN3', 128);
    define('CT_CAPUCHIN4', 129);
    define('CT_CAPUCHIN5A', 130);
    define('CT_CAPUCHIN5B', 131);
    define('CT_OLM1', 132);
    define('CT_OLM2', 133);
    define('CT_OLM3', 134);
    define('CT_OLM4', 135);
    ...
    define('CT_SKINK1', 150);
    define('CT_SKINK2', 151);
    define('CT_SKINK3', 152);
    define('CT_SKINK4', 153);
    define('CT_SKINK5A', 154);
    define('CT_SKINK5B', 155);
    ...
    define('CT_GLASSFROG1', 180);
    define('CT_GLASSFROG2', 181);
    define('CT_GLASSFROG3', 182);
    define('CT_GLASSFROG4', 183);
    define('CT_GLASSFROG5A', 184);
    define('CT_GLASSFROG5B', 185);
    define('CT_GORILLA1', 186);
    define('CT_GORILLA2', 187);
    define('CT_GORILLA3', 188);
    define('CT_GORILLA4', 189);
    define('CT_GORILLA5A', 190);
    define('CT_GORILLA5B', 191);
    define('CT_WALRUS1', 192);
    define('CT_WALRUS2', 193);
    define('CT_WALRUS3', 194);
    define('CT_WALRUS4', 195);
    define('CT_WALRUS5A', 196);
    define('CT_WALRUS5B', 197);
    define('CT_TASMANIANDEVIL1', 198);
    define('CT_TASMANIANDEVIL2', 199);
    define('CT_TASMANIANDEVIL3', 200);
    define('CT_TASMANIANDEVIL4', 201);
    define('CT_TASMANIANDEVIL5A', 202);
    define('CT_TASMANIANDEVIL5B', 203);
    define('CT_JUNGLEFOWL1', 204);
    define('CT_JUNGLEFOWL2', 205);
    define('CT_JUNGLEFOWL3', 206);
    define('CT_JUNGLEFOWL4', 207);
    define('CT_JUNGLEFOWL5A', 208);
    define('CT_JUNGLEFOWL5B', 209);
    ...
    define('CT_DODOMONO', 241);
    define('CT_CAPUCHINMONO', 242);
    define('CT_OLMMONO', 243);
    define('CT_RESOURCEFULMEMBER', 244);
    define('CT_IMPULSIVEMEMBER', 245);
    define('CT_SKINKMONO', 246);
    define('CT_MASTERMEMBER', 247);
    define('CT_PRISTINEMEMBER', 248);
    define('CT_MEDDLINGMEMBER', 249);
    define('CT_FUMBLINGMEMBER', 250);
    define('CT_GLASSFROGMONO', 251);
    define('CT_GORILLAMONO', 252);
    define('CT_WALRUSMONO', 253);
    define('CT_TASMANIANDEVILMONO', 254);
...
$this->card_types = array(
  0 => array(
      ...
      'type_displayed' => clienttranslate('Clutter'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
      'playable' => false,
  ...
  10 => array(
      ...
      'text' => clienttranslate('Each ${card} you use this turn gets +1 to its value.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  11 => array(
      'type_id' => 11,
      'name' => clienttranslate('Favourite Toy'),
  ...
  12 => array(
      ...
      'text' => clienttranslate('Toss any ${cards3} from the market.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  13 => array(
      ...
      'text' => clienttranslate('Take any 1 ${card} from the market.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => false,
      'has_ability' => false,
  ...
  15 => array(
      ...
      'text' => clienttranslate('Swap this ${card} with any 1 ${card} in the market.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  17 => array(
      ...
      'text' => clienttranslate('Hand size +2 and ${cards3} in the market have +2 cost for this turn.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  22 => array(
      ...
      'text' => clienttranslate('Look at the top 2 ${cards2} of another player\'s deck and toss 1 of them. Discard the other.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  24 => array(
      ...
      'text' => clienttranslate('When you build with this ${card}, you may include clutter ${cards3}.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  25 => array(
      ...
      'text' => clienttranslate('When you build with this ${card}, you may include any animalfolk ${cards3}.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  26 => array(
      ...
      'text' => clienttranslate('When you build with this ${card}, you may include any 1 animalfolk or clutter ${card} from your discard.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  27 => array(
      ...
      'text' => clienttranslate('Swap this ${card} with any 1 ${card} in an opponent\'s stall.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  28 => array(
      ...
      'text' => clienttranslate('When you build with this ${card}, apply +1 or -1 to its value.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  30 => array(
      ...
      'text' => clienttranslate('Roll ${die_ocelot}. Add the rolled value to the value of this ${card} for this turn.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  33 => array(
      ...
      'text' => clienttranslate('Look at the top ${card} of the supply and build a stack with only that ${card} if you can. Otherwise, toss it.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  35 => array(
      ...
      'text' => clienttranslate('If you guess the value of the top ${card} of your deck, take it and decide its value (1-5). Otherwise, discard it.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  40 => array(
      ...
      'text' => clienttranslate('Copy any 1 ${card} in the market.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  41 => array(
      ...
      'text' => clienttranslate('Reveal 1 ${card} and copy it.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  43 => array(
      ...
      'text' => clienttranslate('Before you purchase with this ${card}, rearrange any ${cards3} in the market.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  44 => array(
      ...
      'text' => clienttranslate('Swap this ${card} with any 1 ${card} in your stall.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  47 => array(
      ...
      'text' => clienttranslate('When you purchase with this ${card}, you may keep it in your hand.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  49 => array(
      ...
      'text' => clienttranslate('At the start of your next turn, take any 1 ${card} from the market.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => false,
      'has_ability' => false,
  ...
  53 => array(
      ...
      'text' => clienttranslate('At the start of your next turn, each ${card} you use that turn gets +1 to its value.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  56 => array(
      ...
      'text' => clienttranslate('Draw 1 ${card} from each player\'s deck. Place 1 of them back on top of each player\'s deck.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  63 => array(
      ...
      'text' => clienttranslate('Take 1 random ${card} from each player. Give 1 of them back to each player.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  65 => array(
      ...
      'text' => clienttranslate('Draw 1 ${card} from each player\'s deck. Give 1 of them to each player.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  67 => array(
      ...
      'text' => clienttranslate('Reveal 1 ${card}. Roll ${die_polecat} and multiply the value of that ${card} by the rolled value for this turn.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  78 => array(
      ...
      'text' => clienttranslate('Shuffle and place your discard on your deck.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  80 => array(
      ...
      'text' => clienttranslate('Search your deck for 2 ${cards2} and toss 0-1 of them. Shuffle your deck and place the rest on it in any order.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  84 => array(
      ...
      'text' => clienttranslate('When you purchase with this ${card}, add +1 or +2 to its value.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  87 => array(
      ...
      'text' => clienttranslate('Toss 1 animalfolk ${card}. Take 1 ${card} from the market within 1 of the value of that ${card}.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  90 => array(
      ...
      'text' => clienttranslate('Name a set. Look at the top 4 ${cards3} of your deck and take 1 ${card} of the named set. Discard the rest.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  91 => array(
      ...
      'text' => clienttranslate('When you purchase this ${card} or purchase with it, hand size +1 for this turn.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  92 => array(
      ...
      'text' => clienttranslate('If you guess the value of the top ${card} of another player\'s deck, take it. Otherwise, discard it.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  94 => array(
      ...
      'text' => clienttranslate('Name a set and value. Discard 2 ${cards2} from another player\'s deck one by one, taking matching ${cards2}.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  96 => array(
      ...
      'text' => clienttranslate('Swap this ${card} with the top ${card} of another player\'s discard.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  97 => array(
      ...
      'text' => clienttranslate('Toss the rightmost ${card} from the market. Place the top ${card} of the supply in its place.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  100 => array(
      ...
      'text' => clienttranslate('Toss 0-1 ${card} from the supply. You may swap 1 animalfolk ${card} with the top ${card} of the bin.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  101 => array(
      ...
      'text' => clienttranslate('Swap 1 animalfolk ${card} with 1 ${card} of equal value in any player\'s stall.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  103 => array(
      ...
      'text' => clienttranslate('Toss 1 ${card} from the supply to change the value of this ${card} to be equal to the value of the tossed ${card}.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  104 => array(
      ...
      'text' => clienttranslate('Look at the top 3 ${cards3} of your deck and toss 0-1 of them. You may reorder the rest.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  109 => array(
      ...
      'text' => clienttranslate('At the end of your turn, take 1-2 clutter ${cards2} from your discard.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  114 => array(
      ...
      'text' => clienttranslate('Gain 2 ${coin} on this ${card}. At the start of your next 2 turns, take 1 ${coin} from this ${card}.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  115 => array(
      ...
      'text' => clienttranslate('Spend 1: Draw 1 ${card}.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  117 => array(
      ...
      'text' => clienttranslate('Spend 2: Take any 1 ${card} from your discard.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  118 => array(
      ...
      'text' => clienttranslate('Spend 2: Hand size +2 for this turn.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  119 => array(
      ...
      'text' => clienttranslate('Spend X (1-10): Gain X/2 ${coin} (rounded up).'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  120 => array(
      'type_id' => 120,
      'name' => clienttranslate('Eager Borrower'),
      'text' => clienttranslate('Gain 2 ${coin}. Finish 2.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  121 => array(
      'type_id' => 121,
      'name' => clienttranslate('Promising Invention'),
      'text' => clienttranslate('When you build with this ${card}, spend X (1-3): Add +X to its value.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  122 => array(
      'type_id' => 122,
      'name' => clienttranslate('Pet Boar'),
      'text' => clienttranslate('Toss 1 ${card}. Gain 2 ${coin}. Finish 3.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  124 => array(
      'type_id' => 124,
      'name' => clienttranslate('Nesting Doll'),
      'text' => clienttranslate('Spend 1: Draw 2 ${cards2}. Gain 3 ${coin}. Finish 4.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  125 => array(
      'type_id' => 125,
      'name' => clienttranslate('Company Share'),
  ...
  126 => array(
      'type_id' => 126,
      'name' => clienttranslate('Deceptive Guide'),
      'text' => clienttranslate('Gain 3 ${coin}. Give 1 ${coin} to an opponent.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  127 => array(
      'type_id' => 127,
      'name' => clienttranslate('Coin Keeper'),
      'text' => clienttranslate('Gain 1 ${coin}.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  129 => array(
      'type_id' => 129,
      'name' => clienttranslate('Fishing Pole'),
  ...
  131 => array(
      'type_id' => 131,
      'name' => clienttranslate('Unattended Property'),
  ...
  132 => array(
      'type_id' => 132,
      'name' => clienttranslate('Blind Examiner'),
      'text' => clienttranslate('Toss 0-1 ${card} from the supply. When you purchase with this ${card}, you may purchase the top ${card} of the bin.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  133 => array(
      'type_id' => 133,
      'name' => clienttranslate('Softness Shroud'),
      'text' => clienttranslate('Toss any 1 animalfolk ${card} from your discard to take the ${card} from the middle market slot.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  134 => array(
      'type_id' => 134,
      'name' => clienttranslate('Medicine Masher'),
      'text' => clienttranslate('Toss 1 ${card}. Toss any 0-2 ${cards2} from the market.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  135 => array(
      'type_id' => 135,
      'name' => clienttranslate('Opener Sticks'),
      'text' => clienttranslate('Look at the top 3 ${cards3} of an opponent\'s deck. You may toss 1 of them to take any 1 ${card} from the market. Place all 3 ${cards3} on their discard.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  136 => array(
      'type_id' => 136,
      'name' => clienttranslate('Song-making Stone'),
      'text' => clienttranslate('Look at 3 random ${cards3} from an opponent. You may toss 1 of them to give 1 ${card} from the market to that opponent.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  141 => array(
      ...
      'text' => clienttranslate('When you build with this ${card}, spend X (1+): Its is X/2 (rounded up).'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  143 => array(
      ...
      'text' => clienttranslate('Each ${card} valued 1 you use this turn is valued 5, each 2 is 4, and vice versa.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  148 => array(
      ...
      'text' => clienttranslate('Discard 1-3 ${cards3} from your deck one by one. Finish 3: Take any 1 ${card} from your discard.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  149 => array(
      ...
      'text' => clienttranslate('Finish 3: Each ${card} you use this turn gets +1 to its value.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  150 => array(
      'type_id' => 150,
      'name' => clienttranslate('Erratic Assistant'),
      'text' => clienttranslate('At the end of this turn, discard 1-2 ${cards2} and draw as many.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  151 => array(
      'type_id' => 151,
      'name' => clienttranslate('Mint Pastilles'),
      'text' => clienttranslate('Draw 1 ${card} from the supply. At the end of this turn, toss 1 animalfolk ${card} or this ${card}.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  152 => array(
      'type_id' => 152,
      'name' => clienttranslate('Matches'),
      'text' => clienttranslate('Draw 2 ${cards2}. At the end of this turn, toss 1 ${card}.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  153 => array(
      ...
      'text' => clienttranslate('At the end of this turn, search your deck for 1 ${card}. Shuffle your deck.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  154 => array(
      ...
      'text' => clienttranslate('Draw 3 ${cards3}. At the end of this turn, discard 2 ${cards2}.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  155 => array(
      'type_id' => 155,
      'name' => clienttranslate('Smoke Grenade'),
  ...
  156 => array(
      ...
      'text' => clienttranslate('Next time you gain a new ${card} from the market, take any 1 ${card} from your discard.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  157 => array(
      ...
      'text' => clienttranslate('Before you build your next stack, take any 1 ${card} from the market.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => false,
      'has_ability' => false,
  ...
  158 => array(
      ...
      'text' => clienttranslate('Next time you gain a new ${card} from the market, toss any 0-1 ${card} from your discard.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  159 => array(
      ...
      'text' => clienttranslate('Before you build your next stack, take any 1 ${card} from your discard.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  160 => array(
      ...
      'text' => clienttranslate('Next time you form a new deck, do so with any 3 ${cards3} from your discard.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  163 => array(
      ...
      'text' => clienttranslate('At the end of your turn, discard 2 clutter ${cards2} to draw 3 ${cards3}.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  165 => array(
      ...
      'text' => clienttranslate('Draw ${cards3} until you draw 1 non-clutter ${card}. Discard any clutter ${cards3} drawn.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  167 => array(
      ...
      'text' => clienttranslate('While this ${card} is in your stall, you may include 1 clutter ${card} in each new stack.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  168 => array(
      ...
      'text' => clienttranslate('Look at the top 3 ${cards3} of your deck and discard any number of them. You may reorder the rest.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  173 => array(
      ...
      'text' => clienttranslate('Take any number of the top 3 ${cards3} of your discard. Place 1 of them on any player\'s discard and the rest on your deck in any order.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  175 => array(
      ...
      'text' => clienttranslate('Discard 1-3 ${cards3} from any player\'s deck one by one.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  180 => array(
      'type_id' => 180,
      'name' => clienttranslate('Bouncy Researcher'),
      'text' => clienttranslate('Discard 1 ${card} to draw 1 ${card}. Repeat. '),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  181 => array(
      'type_id' => 181,
      'name' => clienttranslate('Gyroscope'),
      'text' => clienttranslate('Look at the top ${card} of the supply. Toss any 1 ${card} from the market. Place the top ${card} in its place. Repeat. '),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  182 => array(
      'type_id' => 182,
      'name' => clienttranslate('Time Capsule'),
  ...
  183 => array(
      ...
      'text' => clienttranslate('Search your deck for 1 ${card}. Shuffle your deck and place that ${card} on it. Repeat.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  184 => array(
      'type_id' => 184,
      'name' => clienttranslate('Yoyo'),
      'text' => clienttranslate('Add +1 to the value of 1 random ${card} in your hand for this turn. Repeat.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  185 => array(
      'type_id' => 185,
      'name' => clienttranslate('Magician’s Touch'),
      'text' => clienttranslate('Look at the top ${card} of your deck. You may swap it with the top ${card} of your discard.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  186 => array(
      'type_id' => 186,
      'name' => clienttranslate('Stubborn Isolationist'),
  ...
  187 => array(
      'type_id' => 187,
      'name' => clienttranslate('Teacher of Fables'),
      'text' => clienttranslate('Discard your hand. Take any 1 ${card} from the market.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => false,
      'has_ability' => false,
  ...
  188 => array(
      'type_id' => 188,
      'name' => clienttranslate('Pure Strength'),
  ...
  189 => array(
      'type_id' => 189,
      'name' => clienttranslate('Blunt Education'),
      'text' => clienttranslate('Each ${card} you use this turn is valued 4.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  190 => array(
      'type_id' => 190,
      'name' => clienttranslate('Bar of Soap'),
  ...
  191 => array(
      'type_id' => 191,
      'name' => clienttranslate('Crown of Sorrow'),
      'text' => clienttranslate('Toss all ${cards3} from the market, fill it, and take 1 ${card} from there.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => false,
      'has_ability' => false,
  ...
  192 => array(
      'type_id' => 192,
      'name' => clienttranslate('Hefty Director'),
      'text' => clienttranslate('When you build with this ${card}, add +1 or +2 to its value.'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => false,
  ...
  193 => array(
      'type_id' => 193,
      'name' => clienttranslate('Slappy Tappy'),
  ...
  194 => array(
      'type_id' => 194,
      'name' => clienttranslate('Sea Salt'),
      'text' => clienttranslate('When you build this turn, you may include 1 clutter ${card}.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  196 => array(
      'type_id' => 196,
      'name' => clienttranslate('Treasure Hoard'),
  ...
  197 => array(
      'type_id' => 197,
      'name' => clienttranslate('Oceanic Icon'),
  ...
  201 => array(
      ...
      'text' => clienttranslate('Look at the top 3 ${cards3} of any player\'s deck and discard any number of them. Shuffle their deck.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  203 => array(
      ...
      'text' => clienttranslate('Shuffle any player\'s discard. Swap 3 random ${cards3} from them with the top ${cards3} of their discard.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  204 => array(
      'type_id' => 204,
      'name' => clienttranslate('Early Riser'),
  ...
  205 => array(
      'type_id' => 205,
      'name' => clienttranslate('Morning Duty'),
  ...
  206 => array(
      'type_id' => 206,
      'name' => clienttranslate('Sewing Essentials'),
  ...
  207 => array(
      'type_id' => 207,
      'name' => clienttranslate('Feather Duster'),
  ...
  208 => array(
      'type_id' => 208,
      'name' => clienttranslate('Organised Cabinets'),
      'text' => clienttranslate('Shuffle your discard. Take any 1 ${card} of the top 2 ${cards2} [${dawn} +2 ${cards2}] of your discard.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  209 => array(
      'type_id' => 209,
      'name' => clienttranslate('Serving Dish'),
      'text' => clienttranslate('Draw 1 ${card}. Apply [${dawn} +2] [${day} +1] [${night} -1] to its value for this turn.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  214 => array(
      ...
      'text' => clienttranslate('Discard 1-3 ${cards3}. Draw [${dawn} 1 ${card}] [${day} as many ${cards3}] [${night} 1 ${card}].'),
      'type_displayed' => clienttranslate('Passive'),
      'is_technique' => false,
      'has_plus' => false,
      'has_ability' => true,
  ...
  221 => array(
      ...
      'text' => clienttranslate('Discard 1 random ${card} from you [${night} or another player]. You may toss it.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  223 => array(
      ...
      'text' => clienttranslate('Mono takes the highest valued ${card} from the market.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => false,
      'has_ability' => false,
  ...
  224 => array(
      ...
      'text' => clienttranslate('Mono swaps 1 random ${card} from you with 1 clutter ${card} from it. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => true,
  ...
  227 => array(
      ...
      'text' => clienttranslate('If Mono\'s discard has no Mono ${cards3}, flip and place its deck on its discard. Mono plays 1 Mono ${card} from its discard. '),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  230 => array(
      ...
      'text' => clienttranslate('Mono draws 1 ${card} from your deck. It places back its lowest valued ${card}. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => true,
  ...
  234 => array(
      ...
      'text' => clienttranslate('Mono discards all clutter ${cards3}. It draws as many ${cards3} +1. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => true,
  ...
  236 => array(
      ...
      'text' => clienttranslate('You discard 1 random ${card}. If its value matches any ${cards3} in the market, Mono takes it. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => true,
  ...
  241 => array(
      'type_id' => 241,
      'name' => clienttranslate('Rash Member'),
      'text' => clienttranslate('Mono gains 12 ${coin}. Mono\'s hand size -2 for this turn. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => true,
  ...
  242 => array(
      'type_id' => 242,
      'name' => clienttranslate('Deceptive Member'),
      'text' => clienttranslate('Mono takes 1 ${coin} from you. Discard 1 ${card} from your deck. If it is not clutter, Mono takes it. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => true,
  ...
  243 => array(
      'type_id' => 243,
      'name' => clienttranslate('Blind Member'),
      'text' => clienttranslate('You toss 1 random animalfolk ${card} valued 2+ to take the lowest valued ${card} from the market. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  244 => array(
      ...
      'text' => clienttranslate('Add +1 to Mono\'s highest valued animalfolk ${card} for each clutter ${card} in its hand.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => false,
  ...
  246 => array(
      'type_id' => 246,
      'name' => clienttranslate('Erratic Member'),
      'text' => clienttranslate('At the end of Mono\'s turn, it draws 1 ${card} from the supply.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => false,
      'has_ability' => false,
  ...
  247 => array(
      ...
      'text' => clienttranslate('Next time Mono fails to build, it takes the highest valued ${card} from the market and tries to build again.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => false,
      'has_ability' => false,
  ...
  248 => array(
      ...
      'text' => clienttranslate('Mono draws 4 ${cards3}. Mono places 2 clutter ${cards2} on its deck. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => true,
  ...
  250 => array(
      ...
      'text' => clienttranslate('Roll ${die_pangolins}. Look at 1 ${card} from your ${source}. If it is not clutter, place it into Mono\'s ${destination}. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => true,
  ...
  251 => array(
      'type_id' => 251,
      'name' => clienttranslate('Bouncy Member'),
  ...
  252 => array(
      'type_id' => 252,
      'name' => clienttranslate('Stubborn Member'),
      'text' => clienttranslate('Each ${card} Mono uses this turn is valued 4. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => true,
  ...
  253 => array(
      'type_id' => 253,
      'name' => clienttranslate('Hefty Member'),
  ...
  254 => array(
      ...
      'text' => clienttranslate('You discard 1 random ${card}. Mono shuffles 2 clutter ${cards2} from your discard into your deck. Acquire.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => true,
      'has_ability' => true,
  ...
  255 => array(
      'type_id' => 255,
      'name' => clienttranslate('Early Member'),
  ...
  256 => array(
      ...
      'text' => clienttranslate('Toss [${dawn} 2${cards2}] [${day} 5${cards3}] [${night} 1${card}] from the supply. Mono takes the highest valued of them.'),
      'type_displayed' => clienttranslate('Technique'),
      'is_technique' => true,
      'has_plus' => false,
      'has_ability' => true,
