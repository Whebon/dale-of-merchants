...
if (!defined('CT_CARDBACK')) {
    ...
    define('CT_DEPRECATED_RIGOROUSCHRONICLER', 264);
    define('CT_DEPRECATED_HISTORYLESSON', 265);
    define('CT_DEPRECATED_CULTURALPRESERVATION', 266);
    define('CT_DEPRECATED_SLICEOFLIFE', 267);
    define('CT_DEPRECATED_VORACIOUSCONSUMER', 268);
    define('CT_DEPRECATED_FASHIONHINT', 269);
    define('CT_DEPRECATED_ROYALPRIVILEGE', 270);
    define('CT_DEPRECATED_VELOCIPEDE', 271);
    define('CT_DEPRECATED_INSIGHT', 272);
    define('CT_DEPRECATED_WHIRLIGIG', 273);
...
$this->DISABLED_SOLO_ANIMALFOLK_IDS = array(
    ...
    ANIMALFOLK_MAGPIES,
    ANIMALFOLK_ECHIDNAS,
    ANIMALFOLK_TREEKANGAROOS,
    
    ANIMALFOLK_TUATARAS,
    ANIMALFOLK_DODOS,
    ANIMALFOLK_CAPUCHINS,
    ANIMALFOLK_OLMS,
    ANIMALFOLK_PENGUINS,
