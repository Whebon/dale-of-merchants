...
class action_daleofmerchants extends APP_GameAction
{
	...
	public function actVelocipede()
	{
		...
		$this->game->actVelocipede( $card_id );
		self::ajaxResponse();
	}
	...
	public function actSoundDetectors()
	{
		self::setAjaxMode();
		...
		$this->game->actSoundDetectors( $card_id );
		self::ajaxResponse();
	}
	...
	public function actHistoryLesson()
	{
		self::setAjaxMode();
		...
		$this->game->actHistoryLesson( $card_ids );
		self::ajaxResponse();
	}
	...
	public function actFashionHint()
	{
		...
		$this->game->actFashionHint( $is_tossing );
		self::ajaxResponse();
	}
	...
	public function actCapuchin4()
	{
		...
		$this->game->actCapuchin4( $is_taking_card );
		self::ajaxResponse();
	}

	public function actCapuchin5a()
	{
		self::setAjaxMode();

		/** @var int $take_card_id */
		$take_card_id = self::getArg('take_card_id', AT_int, true);
		/** @var string $discard_card_ids */
		$discard_card_ids = self::getArg('discard_card_ids', AT_numberlist, true);

		$this->game->actCapuchin5a( $take_card_id, $discard_card_ids );
		self::ajaxResponse();
	}

	public function actSkink4()
	{
		self::setAjaxMode();
		...
		$this->game->actSkink4( $card_id );
		self::ajaxResponse();
	}

	public function actJunglefowl5a()
	{
		self::setAjaxMode();
		...
		$this->game->actJunglefowl5a( $card_id );
		self::ajaxResponse();
	}

	public function actSneakyScout()
	{
		self::setAjaxMode();
		...
		$this->game->actSneakyScout( $card_ids );
		self::ajaxResponse();
	}
	...
	public function actOlm5b()
	{
		...
		$this->game->actOlm5b( $card_ids, $player_ids );
		self::ajaxResponse();
	}
	...
	public function actGorilla5a()
	{
		...
		$this->game->actGorilla5a( $card_ids );
		self::ajaxResponse();
	}

	public function actGorilla5b()
	{
		self::setAjaxMode();
		...
		$this->game->actGorilla5b( $card_id );
		self::ajaxResponse();
	}
	...
	public function actTasmanianDevil4()
	{
		self::setAjaxMode();
		...
		$this->game->actTasmanianDevil4( $card_ids );
		self::ajaxResponse();
	}
	...
	public function actDEPRECATED_Cheer()
	{
		...
		$this->game->actDEPRECATED_Cheer( $card_id );
		self::ajaxResponse();
	}

	public function actDEPRECATED_Tasters()
	{
		self::setAjaxMode();
		...
		$this->game->actDEPRECATED_Tasters( $card_id );
		self::ajaxResponse();
	}
}