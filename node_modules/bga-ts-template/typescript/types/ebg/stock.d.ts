...
declare class Stock {
	...
	//private attributes
	protected items: StockItem[];
	protected item_width: number;
	protected apparenceBorderWidth: string;
	...
	*/
	...
	onClickOnItem(evt: MouseEvent): void;
	...
	*/
	...
	/** Sort function (see https://x.boardgamearena.net/data/themereleases/220811-1000/js/modules/stock.js) */
	sortItems(): void;
}
