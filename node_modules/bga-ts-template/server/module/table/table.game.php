...
abstract class Table extends APP_GameClass {
    ...
    /**
     * Has a function `get(int $playerId, int $prefId): ?int` that returns the value of a user preference for a player. It will return the value currently selected in the select combo box, in the top-right menu.
     */
    var $userPreferences; // only available during setupNewGame
}
