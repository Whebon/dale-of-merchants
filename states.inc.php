...
$machinestates = array(
	...
	42 => array(
		...
		'possibleactions' => ['actUsePassiveAbility', 'actFullyResolveTechniqueCard', 'actEndTurn'],
		'transitions' => array(
			'trSamePlayer' => 41,
			'trNextPlayer' => 41,
			'trPassiveAbility' => 41,
	...
	52 => array(
		'name' => 'spyglass',
		'description' => clienttranslate('${resolving_card_name}: ${actplayer} must choose 1 card to take and reorder the rest'),
		'descriptionmyturn' => clienttranslate('${resolving_card_name}: ${you} must choose 1 card to take and reorder the rest'),
		'type' => 'activeplayer',
		'action' => 'stSpyglass',
	...
	73 => array(
		'name' => 'velocipede',
		'description' => clienttranslate('Velocipede: ${actplayer} may choose an animalfolk card from their hand to swap with ${card_name}'),
		'descriptionmyturn' => clienttranslate('Velocipede: ${you} may choose an animalfolk card from your hand to swap with ${card_name}'),
		'type' => 'activeplayer',
		'args' => 'argTopCardBin',
		'possibleactions' => ['actVelocipede'],
		'transitions' => array(
			'trSamePlayer' => 30,
		),
	),
