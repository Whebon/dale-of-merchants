...
export class DaleCard {
    ...
    static readonly CT_DODO1: number = 120;
    static readonly CT_DODO2: number = 121;
    static readonly CT_DODO3: number = 122;
    static readonly CT_DODO4: number = 123;
    static readonly CT_DODO5A: number = 124;
    static readonly CT_DODO5B: number = 125;
    static readonly CT_CAPUCHIN1: number = 126;
    static readonly CT_CAPUCHIN2: number = 127;
    static readonly CT_CAPUCHIN3: number = 128;
    static readonly CT_CAPUCHIN4: number = 129;
    static readonly CT_CAPUCHIN5A: number = 130;
    static readonly CT_CAPUCHIN5B: number = 131;
    static readonly CT_OLM1: number = 132;
    static readonly CT_OLM2: number = 133;
    static readonly CT_OLM3: number = 134;
    static readonly CT_OLM4: number = 135;
    static readonly CT_OLM5A: number = 136;
    static readonly CT_OLM5B: number = 137;
    ...
    static readonly CT_SKINK1: number = 150;
    static readonly CT_SKINK2: number = 151;
    static readonly CT_SKINK3: number = 152;
    static readonly CT_SKINK4: number = 153;
    static readonly CT_SKINK5A: number = 154;
    static readonly CT_SKINK5B: number = 155;
    ...
    static readonly CT_GLASSFROG1: number = 180;
    static readonly CT_GLASSFROG2: number = 181;
    static readonly CT_GLASSFROG3: number = 182;
    static readonly CT_GLASSFROG4: number = 183;
    static readonly CT_GLASSFROG5A: number = 184;
    static readonly CT_GLASSFROG5B: number = 185;
    static readonly CT_GORILLA1: number = 186;
    static readonly CT_GORILLA2: number = 187;
    static readonly CT_GORILLA3: number = 188;
    static readonly CT_GORILLA4: number = 189;
    static readonly CT_GORILLA5A: number = 190;
    static readonly CT_GORILLA5B: number = 191;
    static readonly CT_WALRUS1: number = 192;
    static readonly CT_WALRUS2: number = 193;
    static readonly CT_WALRUS3: number = 194;
    static readonly CT_WALRUS4: number = 195;
    static readonly CT_WALRUS5A: number = 196;
    static readonly CT_WALRUS5B: number = 197;
    static readonly CT_TASMANIANDEVIL1: number = 198;
    static readonly CT_TASMANIANDEVIL2: number = 199;
    static readonly CT_TASMANIANDEVIL3: number = 200;
    static readonly CT_TASMANIANDEVIL4: number = 201;
    static readonly CT_TASMANIANDEVIL5A: number = 202;
    static readonly CT_TASMANIANDEVIL5B: number = 203;
    static readonly CT_JUNGLEFOWL1: number = 204;
    static readonly CT_JUNGLEFOWL2: number = 205;
    static readonly CT_JUNGLEFOWL3: number = 206;
    static readonly CT_JUNGLEFOWL4: number = 207;
    static readonly CT_JUNGLEFOWL5A: number = 208;
    static readonly CT_JUNGLEFOWL5B: number = 209;
    ...
    static readonly CT_DODOMONO: number = 241;
    static readonly CT_CAPUCHINMONO: number = 242;
    static readonly CT_OLMMONO: number = 243;
    static readonly CT_RESOURCEFULMEMBER: number = 244;
    static readonly CT_IMPULSIVEMEMBER: number = 245;
    static readonly CT_SKINKMONO: number = 246;
