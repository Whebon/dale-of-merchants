...
interface GameStates {
	...
	78: {
		...
		'description': 'Sharing is Caring: ${actplayer} must give back all drawn cards',
		'descriptionmyturn': 'Sharing is Caring: ${you} must choose a card and a player',
		'type': 'activeplayer',
	...
	123: {
		'name': 'gorilla5a',
		'description': '${resolving_card_name}: ${actplayer} must discard 6 cards',
		'descriptionmyturn': '${resolving_card_name}: ${you} must discard 6 cards',
		'type': 'activeplayer',
		'action': 'stGorilla5a',
		'args': 'argResolvingCardName',
		'possibleactions': {
	...
	124: {
		'name': 'gorilla5b',
		'description': '${resolving_card_name}: ${actplayer} must take 1 card from the market',
		'descriptionmyturn': '${resolving_card_name}: ${you} must take 1 card from the market',
		'type': 'activeplayer',
		'args': 'argResolvingCardName',
		'possibleactions': {
			'actGorilla5b': [{
